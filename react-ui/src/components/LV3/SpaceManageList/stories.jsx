...
import SpaceManageList from './index';

SpaceManageList.displayName = 'SpaceManageList';
...
storiesOf('Organisms(LV3)/SpaceManageList', module)
  ...
  .add(
    ...
    withInfo(`
      ...
      <div style={{ padding: `${Dimens.storyBookPadding}` }}>
        <SpaceManageList spaces={getData()} />
      </div>
    )),
  );
