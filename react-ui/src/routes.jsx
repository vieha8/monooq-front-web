...
const AboutMonooq = loadable(() =>
  import('components/containers/AboutMonooqContainer').catch(() => window.location.reload()),
);
...
export default ({ history }) => (
  <ConnectedRouter history={history}>
    <Switch>
      ...
      <Route exact path={Path.aboutMonooq()} component={AboutMonooq} />
