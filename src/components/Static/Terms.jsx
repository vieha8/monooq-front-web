...
// 項
const Para = Text.withComponent('p');
...
export default () => (
  <Fragment>
    <MainTitleContainer>
      ...
      <Text>
        本利用規約（以下「本規約」といいます。）には、モノオク株式会社（以下「当社」といいます。）の提供する本サービス（第2条に定義）のご利用にあたり、利用者の皆様に遵守していただかなければならない事項及び当社と利用者の皆様との間の権利義務関係が定められております。本サービスをご利用になる方は、本規約に同意する前に、必ず全文お読み下さいますようお願い致します。
      </Text>
    ...
    <StyledChapterContainer title="第2章　ホストに関する規定">
      <ArtContainer title="第1条 スペース情報の掲載">
        <Para>
      ...
      <ArtContainer title="第2条 スペースの提供等">
        <Para>
      ...
      <ArtContainer title="第3条 ホスト手数料の支払">
        <Para>
      ...
      <ArtContainer title="第4条 スペース利用料の受領">
        <Para>
    ...
    <StyledChapterContainer title="第3章　ユーザーに関する規定">
      <ArtContainer title="第1条 スペースの利用等">
        <Para>
      ...
      <ArtContainer title="第2条 スペース利用料の支払">
        <Para>
      ...
      <ArtContainer title="第3条 ユーザー手数料の支払">
        <Para>
    ...
    <StyledChapterContainer title="第4章　その他">
      <ArtContainer title="第1条 個人情報等の取扱い">
        <Para>
          1.登録利用者は、登録情報に含まれる登録利用者の個人情報（個人情報の保護に関する法律（以下「個人情報保護法」といいます。）第2条1項に定義する個人情報を意味します。）について、当社の<LinkText
            to={Path.privacy()}
          >
            プライバシーポリシー
          </LinkText>に従って取り扱われることに同意するものとします。<br />
      ...
      <ArtContainer title="第2条 アカウント情報の管理">
        <Para>
      ...
      <ArtContainer title="第4条 本サービスの停止等">
        <Para>
      ...
      <ArtContainer title="第5条 公租公課及び設備の負担等">
        <Para>
      ...
      <ArtContainer title="第8条 登録利用者の賠償等の責任">
        <Para>
      ...
      <ArtContainer title="第16条 準拠法及び管轄裁判所">
        <Para>
          本規約の準拠法は日本法とし、本規約に起因し又は関連する一切の紛争については、東京地方裁判所又は東京簡易裁判所を第一審の専属的合意管轄裁判所とします。
        </Para>
      </ArtContainer>

      <ArtContainer title="第17条 協議解決">
        <Para>
