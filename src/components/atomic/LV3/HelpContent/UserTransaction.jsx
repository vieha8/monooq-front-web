...
const QandA = [
  {
    ...
    content:
      'あなたの荷物はとても量が多く、大きなものだったり、一般的ではない荷物ではありませんか？ホストは出来る限りの最適な見積もりを提示してくれています。料金に納得できない場合は丁寧にお断りをしましょう。',
    circleDown: true,
  },
  {
  ...
  // },
  {
    ...
    content:
      'いいえ。事前に了承を得た荷物のみ、ホストの元へ届けてください。ホストの物置きスペースに余裕がない場合はどんなに頑張っても置くことはできません。',
    circleDown: true,
  },
  {
    title: '途中でスペースの延長したくなりました。可能ですか？',
    content:
      'まずはホストに利用延長が可能か確認をしてください。ホストのスケジュールが合えば、追加で決済をすることで延長が可能です。',
    circleDown: true,
  },
  {
  ...
  },
  {
    ...
    content:
      'いいえ、できません。モノオクのサイト以外では決して送金や連絡を行わないようにご注意ください。サービス外での取り引きに対しては、荷物の保証が一切できません。',
    circleDown: true,
  },
];
