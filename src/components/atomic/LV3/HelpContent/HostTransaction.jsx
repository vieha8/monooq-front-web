...
const QandA = [
  {
    ...
    content: 'メッセージで支払いをするように依頼してください。',
    circleDown: true,
  },
  // {
  ...
  {
    title:
      '利用開始日になりましたが、荷物も届かずユーザーとも連絡がとれません。どうすれば良いですか？',
    content:
      '引き続き、メッセージで連絡してみてください。万が一、返事がない場合でも決済されたスペース利用料金はあなたの売上に反映されます。',
    circleDown: true,
  },
  {
    title: '利用終了日になりましたが、ユーザーが引取りに来てくれません。どうすれば良いですか？',
    content:
      '引き続き、メッセージで連絡をお願いします。うっかり利用終了日を忘れているだけかもしれません。モノオクでは問題解決センターを設置しています。トラブル発生の際はこちらまでご依頼ください。',
    circleDown: true,
  },
  {
    title: '掲載したスペース以外に荷物を置いても良いのですか？',
    content:
      'いいえ。必ずモノオクに掲載したスペースに荷物を置いてください。掲載していないスペースでもし事故や破損があった場合は保証の対象外となります。',
    circleDown: true,
  },
  {
    title: 'スペースに置いてはいけない荷物はありますか？',
    content:
      'スペースの利用を行う前にルールとマナーに記載の「<a href="/rule">取引ができない荷物</a>」をお読みください。',
    circleDown: true,
  },
  {
    title: '荷物を破損または紛失してしまいました。どうすれば良いでしょうか？',
    content:
      'もしスペースに置いた荷物に何かあった場合、保険が適用される場合があります。こちらの「<a href="/insurance">荷物に関する保険</a>」ページをお読みください。',
    circleDown: true,
  },
  {
    title: '掲載できないスペースはありますか？',
    content:
      'モノオクでの登録は日本国内のスペースに限ります。また公共の場や自分で管理していないスペース等は登録することができません。',
    circleDown: true,
  },
  {
    title: '荷物の受け取りや管理はホスト本人じゃないとダメですか？',
    content:
      'はい。スペース登録を行ったアカウントのご本人が必ず、受け取りと管理をしてください。もしご本人がやり取りをしなかった場合のトラブルや事故には弊社は責任を負いかねます。',
    circleDown: true,
  },
  {
    title: 'ユーザーから利用期間の延長をしたいと連絡がありました。どうすれば良いですか？',
    content:
      'メッセージでは同じ相手に何回でも見積もりを作成することができます。延長の申し出があった際は、再度見積もりを発行し、ユーザーに決済をしてもらいます。',
    circleDown: true,
  },
  // {
  ...
  },
  {
    ...
    content:
      '当人で解決できないトラブルが発生してしまった場合は、「お問い合わせ」よりモノオク問題解決センターまでご依頼ください。',
    circleDown: true,
  },
];
