...
const QandA = [
  {
    title: 'PickGoとはなんですか？',
    content:
      '単身の引越しや少し大きな荷物の配達に便利な、お客様と配送員を直接つないでくれる配送サービスです。配送料金5000円〜から交渉・依頼できます。<a href="http://pickgo.town/personal/" target="_blank">詳細はこちら</a>',
    circleDown: true,
    anchor: 'common4',
  },
  {
  ...
  //   content: 'スペースの取引完了後にメッセージで通知されます。または「スケジュール」ページの終了したスペース欄に「レビューを投稿する」ボタンがあります。',
  //   circleDown: true,
  //   anchor: 'common4',
  // },
  // {
  ...
  {
    title: '退会をしたい',
    content: 'お手数ですが「お問い合わせ」よりご連絡ください。',
    circleDown: true,
  },
];
