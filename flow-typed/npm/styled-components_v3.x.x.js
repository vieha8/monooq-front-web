...
>;
type $npm$styledComponents$ReactComponentClassUndefinedDefaultProps<Props> = Class<
...
>) &
  ...
  ) => $npm$styledComponents$ReactComponentStyledTaggedTemplateLiteral<Props, ComponentListKeys>);
...
) => $npm$styledComponents$ReactComponentFunctional<OutputProps, OutputDefaultProps>;
...
declare module 'styled-components' {
  ...
  declare export type ReactComponentStyledStaticProps<
    Props,
  > = $npm$styledComponents$ReactComponentStyledStaticPropsWithComponent<Props, ComponentListKeys>;
  declare export type ReactComponentStyled<Props> = $npm$styledComponents$ReactComponentStyled<
    Props,
    ComponentListKeys,
  >;
