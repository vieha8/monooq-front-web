...
declare class $npm$firebase$auth$Auth {
  ...
  createUserWithEmailAndPassword(email: string, password: string): Promise<$npm$firebase$auth$User>;
  ...
  signInWithEmailAndPassword(email: string, password: string): Promise<$npm$firebase$auth$User>;
...
declare class $npm$firebase$auth$GoogleAuthProvider extends $npm$firebase$auth$AuthProvider {
  PROVIDER_ID: string;
  credential(idToken?: string, accessToken?: string): $npm$firebase$auth$AuthCredential;
...
declare class $npm$firebase$auth$PhoneAuthProvider extends $npm$firebase$auth$AuthProvider {
  ...
  credential(verificationId: string, verificationCode: string): $npm$firebase$auth$AuthCredential;
  verifyPhoneNumber(
    phoneNumber: string,
    applicationVerifier: $npm$firebase$auth$ApplicationVerifier,
  ): Promise<string>;
