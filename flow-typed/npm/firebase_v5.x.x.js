// flow-typed signature: 8e11b31554c31764c60e36f3a4c8d550
// flow-typed version: 405b9992d5/firebase_v5.x.x/flow_>=v0.34.x
...
declare type $npm$firebase$auth$Auth$Persistence$Enum = $Values<
  $npm$firebase$auth$Auth$Persistence,
>;
...
declare class $npm$firebase$auth$EmailAuthProvider extends $npm$firebase$auth$AuthProvider {
  ...
  static credential(email: string, password: string): $npm$firebase$auth$AuthCredential;
  static credentialWithLink(email: string, emailLink: string): $npm$firebase$auth$AuthCredential;
  providerId: string;
}
...
declare class $npm$firebase$auth$FacebookAuthProvider extends $npm$firebase$auth$AuthProvider {
  ...
  setCustomParameters(customOAuthParameters: Object): $npm$firebase$auth$FacebookAuthProvider;
  providerId: string;
}
...
declare class $npm$firebase$auth$GithubAuthProvider extends $npm$firebase$auth$AuthProvider {
  ...
  setCustomParameters(customOAuthParameters: Object): $npm$firebase$auth$GithubAuthProvider;
  providerId: string;
}
...
declare class $npm$firebase$auth$GoogleAuthProvider extends $npm$firebase$auth$AuthProvider {
  ...
  static PROVIDER_ID: string;
  static credential(idToken?: string, accessToken?: string): $npm$firebase$auth$AuthCredential;
  addScope(scope: string): $npm$firebase$auth$GoogleAuthProvider;
  setCustomParameters(customOAuthParameters: Object): $npm$firebase$auth$GoogleAuthProvider;
}
...
declare class $npm$firebase$auth$PhoneAuthProvider extends $npm$firebase$auth$AuthProvider {
  ...
  constructor(auth?: $npm$firebase$auth$Auth): $npm$firebase$auth$PhoneAuthProvider;
  verifyPhoneNumber(
    phoneNumber: string,
    applicationVerifier: $npm$firebase$auth$ApplicationVerifier,
  ): Promise<string>;
...
declare type $npm$firebase$database$OnCompleteCallback = (error: ?Object) => void;
...
declare class $npm$firebase$database$Query {
  ref: $npm$firebase$database$Reference;
  endAt(value: number | string | boolean | null, key?: string): $npm$firebase$database$Query;
  equalTo(value: number | string | boolean | null, key?: string): $npm$firebase$database$Query;
  ...
  startAt(value: number | string | boolean | null, key?: string): $npm$firebase$database$Query;
  toJSON(): Object;
  toString(): string;
}
...
declare class $npm$firebase$database$Reference extends $npm$firebase$database$Query {
  ...
  transaction(
    transactionUpdate: (data: $npm$firebase$database$Value) => $npm$firebase$database$Value,
    onComplete?: (
      error: null | Object,
      committed: boolean,
...
declare class $npm$firebase$firestore$Firestore {
  ...
  runTransaction(
    updateFunction: (transaction: $npm$firebase$firestore$Transaction) => Promise<any>,
  ): Promise<mixed>;
...
declare type $npm$firebase$firestore$documentObserver = (
  snapshot: $npm$firebase$firestore$DocumentSnapshot,
) => void | Promise<void>;
declare type $npm$firebase$firestore$queryObserver = (
  snapshot: $npm$firebase$firestore$QuerySnapshot,
) => void | Promise<void>;
declare type $npm$firebase$firestore$observerError = (
  error: $npm$firebase$Error,
) => void | Promise<void>;
...
declare class $npm$firebase$firestore$Query {
  firestore: $npm$firebase$firestore$Firestore;
  endAt(
    snapshotOrVarArgs: $npm$firebase$firestore$DocumentSnapshot | {},
  ): $npm$firebase$firestore$Query;
  endBefore(
    snapshotOrVarArgs: $npm$firebase$firestore$DocumentSnapshot | {},
  ): $npm$firebase$firestore$Query;
  get(
    getOptions?: $npm$firebase$firestore$GetOptions,
  ): Promise<$npm$firebase$firestore$QuerySnapshot>;
...
/** **** storage ******/
declare type $npm$firebase$storage$StringFormat = 'raw' | 'base64' | 'base64url' | 'data_url';
...
> {
  ...
  cancel(): boolean;
  on(event: $npm$firebase$storage$TaskEvent, ...rest: Array<void>): $npm$firebase$storage$Subscribe;
  on(
